...
abstract class $NoteCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String publicKey, NoteTitle title, NoteBody body});
}
...
class _$_Note extends _Note {
  ...
  @override
  String toString() {
    return 'Note(id: $id, publicKey: $publicKey, title: $title, body: $body)';
  }
...
abstract class _Note extends Note {
  const factory _Note(
      ...
      required final NoteBody body}) = _$_Note;
